{application,credo,
             [{applications,[kernel,stdlib,elixir,bunt,crypto,eex,ex_unit,
              ...
              {modules,['Elixir.Credo','Elixir.Credo.Application',
                        ...
                        'Elixir.Credo.CLI.Command.Diff.DiffCommand.FilterIssues',
                        'Elixir.Credo.CLI.Command.Diff.DiffCommand.FilterIssuesForExitStatus',
                        'Elixir.Credo.CLI.Command.Diff.DiffCommand.GetGitDiff',
                        'Elixir.Credo.CLI.Command.Diff.DiffCommand.PrintBeforeInfo',
                        'Elixir.Credo.CLI.Command.Diff.DiffCommand.PrintResultsAndSummary',
